...
global DATA = "C:\Users\estef\Desktop\San Andrés\2022\2do trimestre\Herramientas computacionales para investigación\Tarea 5\videos 2 y 3 2022\videos 2 y 3\data" 
cd "$DATA"
...
* Del shapefile generó una base con los datos y otra con las coordenadas
...
** tp
gen cripop = crimecount/Pop_2001
spmap cripop using coord_ls, id(id) clmethod(e) cln(6) title("Cantidad de robos per cápita") legend(size(small) position(5) xoffset(15)) fcolor(Blues) plotregion(margin(b+15)) ndfcolor(gray)   
